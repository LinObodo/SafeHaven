...
import { Eye, EyeOff, Shield, UserX } from 'lucide-react';
...
const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-ivory-50 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <QuickExitButton />
